...
def display_page(pathname):
    if pathname == "/DASHAPP/backpack":
        return backpack.create_layout(app)
    elif pathname == "/DASHAPP/wine":
        return wine.create_layout(app)
...
def update_table(page_current, page_size, sort_by, filter):
    ...
    if len(sort_by):
        dff = dff.sort_values(
            ...
            inplace=False
>>>>>>> a74bd5746ee3e40aaa995b0b9701f59b01dadda4
        )
    else:
        return backpack.create_layout(app)
